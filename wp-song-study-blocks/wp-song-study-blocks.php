...
$wpssb_vendor_autoload = WPSSB_PATH . 'vendor/autoload.php';
if ( file_exists( $wpssb_vendor_autoload ) ) {
    require_once $wpssb_vendor_autoload;
}
...
require_once WPSSB_PATH . 'includes/rehearsal-web-push.php';
